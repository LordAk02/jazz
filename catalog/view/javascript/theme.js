...
$(document).ready(() => {
    ...
    jQuery(".product-list-js .product-layout,.ishispecial .product-thumb,.feature_container .product-container,#product-list .product-container,#product-list .product-container,.latestproduct .product-layout,.ishiproductsblock .item,.related-product .product-thumb,.ishibannerwithproductblock .product-container,.ishispecial .product-thumb").each(function() {
